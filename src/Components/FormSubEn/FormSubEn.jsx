...
export default function FormSubEn() {
            ...
            planData = [
                {
                    ...
                    id: "silver",
                    discountPrice: plan_Id.split("-")[1],
                    price: "1,999EGP",
                }
            ]
        } else if (plan_Id.split("-")[0] == "golden") {
            planData = [
                {
                    title: "الخطة الذهبية",
                    disCount: " ",
    ...
    return <>
        ...
        <div id="SubscribeFormEn" className=" bg-lightGrayBack dir-ltr" >


            <div className="container formSub flex flex-wrap py-12 justify-between">

                <div className="grid dir-ltr w-full lg:w-2/3 p-3">
                    <div className="w-full p-12 bg-white rounded-2xl shadow-cardShadow">
                        <h1 className="font-bold text-2xl">Personal Information</h1>
                        <form className="mt-6">

                            <label htmlFor="firstname" className="block text-xl font-semibold text-gray-700 ">Name</label>
                            ...
                            <label htmlFor="email" className="block mt-4 text-xl font-semibold text-gray-700 ">Email</label>
                            ...
                            <label htmlFor="phoneNumber" className="block mt-2 text-xl font-semibold text-gray-700 "> Phone Number </label>
                            ...
                            <div className="paymentInfo py-5 mt-5 flex flex-wrap">
                                <h3 className="mb-3 font-bold w-full text-2xl">Payment Methods</h3>
                                ...
                                <div className="w-full md:w-1/2 p-3 py-5" id="stripe-option">
                                    <div className="flex items-center gap-3 rounded-lg cursor-pointer bg-lightGrayBack shadow-cardShadow p-3 border">
                                        ...
                                        <label htmlFor="stripePay" className="w-full mb-0">
                                            <img className="h-20" src="https://www.momaher.com/site/images/credit.svg" alt="" id="amazon-pay-img" />
                                            <h4 className="font-bold py-1" id="stripe-title">Credit Card</h4>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div className="w-full md:w-1/2 p-3 py-5" id="fawaterak-option-2">
                                    <div className="flex items-center gap-3 rounded-lg cursor-pointer bg-lightGrayBack shadow-cardShadow p-3 border">
                                        ...
                                        <label htmlFor="fawaterakPay2" className="w-full mb-0">
                                ...
                                <div className="w-full md:w-1/2 p-3 py-5" id="fawaterak-option-3">
                                    <div className="flex items-center gap-3 rounded-lg cursor-pointer bg-lightGrayBack shadow-cardShadow p-3 border">
                                        ...
                                        <label htmlFor="fawaterakPay3" className="w-full mb-0">
