...
export default function Instructors() {
    ...
    return (
        <div id="Instructors" className="py-7 overflow-hidden  ">
            ...
            <a href="#" data-scroll-to="ChoosePlan" className="btn flex justify-center px-4 my-5">
                <button className='p-4 px-16  flex flex-col justify-center items-center text-white shadow-cardShadow rounded'>
                    <span className="mb-2 text-xl lg:text-2xl ">  {t("subscribeNow_Instuctors")} </span>
                </button>
            </a>
